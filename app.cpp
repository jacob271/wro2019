...
void test()
{
	line1(1, 4, pGL1, dGL1, LSl, false, "degree", 300, 4, false);
	move(cSpeed, 4, 0.9, 1, "degree", 700, 4, false);
	move(cSpeed, 4, 1, 1, "degree", 1000, 1, true);
	return;
...
void main_task(intptr_t unused)
{
	...
	positionenScannen();
	city(9, 4, 6, 4, false);
	line1(4, 4, pGL1, dGL1, LSr, true, "crossline", 0, 4, false);
	line1(4, 4, pGL1, dGL1, LSr, true, "degree", 125, 1, true);
	turn2(1, 5, "degree", -spin90, 1, true);
